---
name: program-design
description: Change-scoped program design: code shape, types, call flow, file layout, vertical slices. Distinct from architecture.
...
- System-level components and contracts: architecture. Unclear system boundaries: settle them before writing.
...
- Project context when present: ARCHITECTURE.md, ADRs, codebase, prior design notes.
